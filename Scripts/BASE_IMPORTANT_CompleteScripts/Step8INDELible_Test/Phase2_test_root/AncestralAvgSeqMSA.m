...
%addpath("/Users/pouloeld/Documents/INDELIble/INDELiIble_SIM/INDELible_sim_NewickTrees/4_POW_1.7_method1_5000replicates/test4/test4_L_0.04_I_0.05")
%TestPath= "/Users/pouloeld/Documents/INDELIble/INDELiIble_SIM/INDELible_sim_NewickTrees/4_POW_1.7_method1_5000replicates/test4/test4_L_0.04_I_0.05";
...
% title("Lambda=0.04, Mu= 0.05")

% z=SeqperMSA;
% %z(z>200)=[];
% %subplot(2,1,1);
boxplot(SeqperMSA_matrix(:,1:20))
xlabel("Replicates")
ylabel("Average of Sequence length")
