...
%%
addpath('/Users/pouloeld/Documents/Alignment_Generation/outputs/Alignment_MAFFT/ProPIP_Aligned')

addpath('/Users/pouloeld/Documents/ProPIP/Params_Generation/scripts') %% for using nwk2tree file

%% Paths
%InferredMSA path
mafftSeq_path= '/Users/pouloeld/Documents/Alignment_Generation/outputs/Alignment_MAFFT/ProPIP_Aligned';
mafftSeq_name= 'mafftInferredMSA_P_';
Seq_ext= '.fasta';


%% Input info
%Sequences
SeqPath= '/Users/pouloeld/Documents/Alignment_Generation/outputs/Alignment_MAFFT/ProPIP_Aligned';
Seqfiles= dir(fullfile(SeqPath,'*.fasta'));
allSeqNames= {Seqfiles.name};
sk= regexp(allSeqNames,'((?<=alignedMSA_P_)\d*)','match');
