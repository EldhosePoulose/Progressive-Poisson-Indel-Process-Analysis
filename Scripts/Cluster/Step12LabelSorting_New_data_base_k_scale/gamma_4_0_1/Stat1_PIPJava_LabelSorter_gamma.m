...
%% Readin TRUE MSA
%INDELible
% True_I_Path="/Users/pouloeld/Documents/Statistics2/PIPJava/True/wo_shuffling"; 
% True_I_files= dir(fullfile(True_I_Path,'*_MSA.fasta'));
% True_I_Names= {True_I_files.name};
% tk_i= regexp(True_I_Names,'((?<=sim-)\d*)|((?<=_MSA))','match');
...
% ProPIP + Gamma n=4, a=0.1
Inf_I_Path0= strcat('/Users/pouloeld/Documents/Statistics2/PIPJava/ProPIP/Gamma','/',baseType0); 
Inf_I_files0= dir(fullfile(Inf_I_Path0,'*.fasta'));
Inf_I_Names0= {Inf_I_files0.name};
tk_i0= regexp(Inf_I_Names0,'((?<=ProPIPgamma4inferredMSA_P_)\d*)','match');
...
% Inf_I_files0= dir(fullfile(Inf_I_Path0,'*.fasta'));
% Inf_I_Names0= {Inf_I_files0.name};
% tk_i0= regexp(Inf_I_Names0,'((?<=ProPIPgamma0inferredMSA_P_)\d*)','match');
% [~,ti0]= sortrows(str2double(cat(1,tk_i0{:})));
% Inf_I_Names0= Inf_I_Names0(ti0); %tii for INDELible tpp for PIPJava trr for real
% nIter_I0= length(Inf_I_Names0);
% 
% % ProPIP + Gamma n=4, a=1.0
% Inf_I_Path1= strcat('/Users/pouloeld/Documents/Statistics2/PIPJava/ProPIP/Gamma','/',baseType1); 
% Inf_I_files1= dir(fullfile(Inf_I_Path1,'*.fasta'));
% Inf_I_Names1= {Inf_I_files1.name};
% tk_i1= regexp(Inf_I_Names1,'((?<=ProPIPgamma1inferredMSA_P_)\d*)','match');
...
% Inf_I_Path2= strcat('/Users/pouloeld/Documents/Statistics2/PIPJava/ProPIP/Gamma','/',baseType2); 
% Inf_I_files2= dir(fullfile(Inf_I_Path2,'*.fasta'));
% Inf_I_Names2= {Inf_I_files2.name};
% tk_i2= regexp(Inf_I_Names2,'((?<=ProPIPgamma2inferredMSA_P_)\d*)','match');
...
% Inf_I_Path3= strcat('/Users/pouloeld/Documents/Statistics2/PIPJava/ProPIP/Gamma','/',baseType3); 
% Inf_I_files3= dir(fullfile(Inf_I_Path3,'*.fasta'));
% Inf_I_Names3= {Inf_I_files3.name};
% tk_i3= regexp(Inf_I_Names3,'((?<=ProPIPgamma3inferredMSA_P_)\d*)','match');
