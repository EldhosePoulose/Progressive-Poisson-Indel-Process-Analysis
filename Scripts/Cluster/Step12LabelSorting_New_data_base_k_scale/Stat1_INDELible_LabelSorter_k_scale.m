...
%% Add paths
addpath("/Users/pouloeld/Documents/Statistics2/INDELible/ProPIP/k_scale/k_0_25")
addpath("/Users/pouloeld/Documents/Statistics2/INDELible/ProPIP/k_scale/k_0_5")
addpath("/Users/pouloeld/Documents/Statistics2/INDELible/ProPIP/k_scale/k_2_0")
addpath("/Users/pouloeld/Documents/Statistics2/INDELible/ProPIP/k_scale/k_3_0")
...
% k_0_25
Inf_I_Path1= "/Users/pouloeld/Documents/Statistics2/INDELible/ProPIP/k_scale/k_0_25"; 
Inf_I_files1= dir(fullfile(Inf_I_Path1,'*.fasta'));
Inf_I_Names1= {Inf_I_files1.name};
tk_i1= regexp(Inf_I_Names1,'((?<=ProPIPk0inferredMSA_I_)\d*)','match');
...
% k_0_5
Inf_I_Path2= "/Users/pouloeld/Documents/Statistics2/INDELible/ProPIP/k_scale/k_0_5"; 
Inf_I_files2= dir(fullfile(Inf_I_Path2,'*.fasta'));
Inf_I_Names2= {Inf_I_files2.name};
tk_i2= regexp(Inf_I_Names2,'((?<=ProPIPk1inferredMSA_I_)\d*)','match');
...
% k_2_0
Inf_I_Path3= "/Users/pouloeld/Documents/Statistics2/INDELible/ProPIP/k_scale/k_2_0"; 
Inf_I_files3= dir(fullfile(Inf_I_Path3,'*.fasta'));
Inf_I_Names3= {Inf_I_files3.name};
tk_i3= regexp(Inf_I_Names3,'((?<=ProPIPk2inferredMSA_I_)\d*)','match');
...
% k_3_0
Inf_I_Path4= "/Users/pouloeld/Documents/Statistics2/INDELible/ProPIP/k_scale/k_3_0"; 
Inf_I_files4= dir(fullfile(Inf_I_Path4,'*.fasta'));
Inf_I_Names4= {Inf_I_files4.name};
tk_i4= regexp(Inf_I_Names4,'((?<=ProPIPk3inferredMSA_I_)\d*)','match');
