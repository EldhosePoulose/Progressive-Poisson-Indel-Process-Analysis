...
matlab -nodisplay < /cfs/earth/scratch/pouloeld/runFiles/matFiles/main_stft_r_h1.m
matlab -nodisplay < /cfs/earth/scratch/pouloeld/runFiles/matFiles/main_stft_r_h2.m