...
matlab -nodisplay < /cfs/earth/scratch/pouloeld/runFiles/matFiles/main_stft_r_w1.m
matlab -nodisplay < /cfs/earth/scratch/pouloeld/runFiles/matFiles/main_stft_r_w2.m