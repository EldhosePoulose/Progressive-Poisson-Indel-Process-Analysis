...
matlab -nodisplay < /cfs/earth/scratch/pouloeld/runFiles/matFiles/main_stft_I_h1.m
matlab -nodisplay < /cfs/earth/scratch/pouloeld/runFiles/matFiles/main_stft_I_h2.m