...
matlab -nodisplay < /cfs/earth/scratch/pouloeld/runFiles/matFiles/main_stft_I_w1.m
matlab -nodisplay < /cfs/earth/scratch/pouloeld/runFiles/matFiles/main_stft_I_w2.m