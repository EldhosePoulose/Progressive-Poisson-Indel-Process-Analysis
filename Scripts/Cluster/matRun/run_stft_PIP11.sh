...
matlab -nodisplay < /cfs/earth/scratch/pouloeld/runFiles/matFiles/main_stft_P_h1.m
matlab -nodisplay < /cfs/earth/scratch/pouloeld/runFiles/matFiles/main_stft_P_h2.m