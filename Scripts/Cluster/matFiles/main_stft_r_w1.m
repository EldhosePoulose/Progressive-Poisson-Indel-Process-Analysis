...
addpath(strcat(pcPath,'Alignment_Generation/inputs/realData_ins/ungappedMSA_realData'))
addpath(strcat(pcPath,'Alignment_Generation/inputs/realData_ins/newicktree_realData'))
addpath(strcat(pcPath,'ProPIP/Params_Generation/outputs/realData_outs/lambda_mu'));
...
%% OUT file path
output_MSA_path= strcat(pcPath,'Alignment_Generation/STFT/outputs/real/welch/w_128');
output_file_name= 'ProPIP_stft_w_128_MSA_r_';
Seq_ext= ".fasta";

%% INPUTS file details

%1 ungapped MSAs
msaPath= strcat(pcPath,'Alignment_Generation/inputs/realData_ins/ungappedMSA_realData');
...
%2 Trees
treePath= strcat(pcPath,'Alignment_Generation/inputs/realData_ins/newicktree_realData');
...
%3 lambda mu files
lambdamuPath= strcat(pcPath,'ProPIP/Params_Generation/outputs/realData_outs/lambda_mu');
