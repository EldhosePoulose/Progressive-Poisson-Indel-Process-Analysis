...
addpath(strcat('/Users/pouloeld/Documents/Statistics2/PIPJava/ProPIP/k_scale','/',baseType0))
addpath(strcat('/Users/pouloeld/Documents/Statistics2/PIPJava/ProPIP/k_scale','/',baseType1))
addpath(strcat('/Users/pouloeld/Documents/Statistics2/PIPJava/ProPIP/k_scale','/',baseType2))
addpath(strcat('/Users/pouloeld/Documents/Statistics2/PIPJava/ProPIP/k_scale','/',baseType3))
...
% ProPIP + k-scale-0.25
Inf_P_Path0= strcat('/Users/pouloeld/Documents/Statistics2/PIPJava/ProPIP/k_scale','/',baseType0); 
Inf_P_files0= dir(fullfile(Inf_P_Path0,'*.fasta'));
Inf_P_Names0= {Inf_P_files0.name};
tk_i0= regexp(Inf_P_Names0,'((?<=ProPIPk0inferredMSA_P_)\d*)','match');
...
% ProPIP + k-scale-0.5
Inf_P_Path1= strcat('/Users/pouloeld/Documents/Statistics2/PIPJava/ProPIP/k_scale','/',baseType1); 
Inf_P_files1= dir(fullfile(Inf_P_Path1,'*.fasta'));
Inf_P_Names1= {Inf_P_files1.name};
tk_i1= regexp(Inf_P_Names1,'((?<=ProPIPk1inferredMSA_P_)\d*)','match');
...
% ProPIP + k-scale-2.0
Inf_P_Path2= strcat('/Users/pouloeld/Documents/Statistics2/PIPJava/ProPIP/k_scale','/',baseType2); 
Inf_P_files2= dir(fullfile(Inf_P_Path2,'*.fasta'));
Inf_P_Names2= {Inf_P_files2.name};
tk_i2= regexp(Inf_P_Names2,'((?<=ProPIPk2inferredMSA_P_)\d*)','match');
...
% ProPIP + k-scale-3.0
Inf_P_Path3= strcat('/Users/pouloeld/Documents/Statistics2/PIPJava/ProPIP/k_scale','/',baseType3); 
Inf_P_files3= dir(fullfile(Inf_P_Path3,'*.fasta'));
Inf_P_Names3= {Inf_P_files3.name};
tk_i3= regexp(Inf_P_Names3,'((?<=ProPIPk3inferredMSA_P_)\d*)','match');
...
%     ylabel('frequency')
    ...
    figure,
    histogram(Inf_P_countMSA0,'Normalization','count')
    title(strcat('ProPIP+k-scale-0.25,Inferred-MSA',int2str(namesP0)))
    xlabel('Indel length')
    ylabel('frequency')
...
%     ylabel('frequency')
    ...
    figure,
    histogram(Inf_P_countMSA1,'Normalization','count')
    title(strcat('ProPIP+k-scale-0.5,-Inferred-MSA',int2str(namesP1)))
    xlabel('Indel length')
    ylabel('frequency')
...
%     ylabel('frequency')
    ...
    figure,
    histogram(Inf_P_countMSA2,'Normalization','count')
    title(strcat('ProPIP+k-scale-2.0,-Inferred-MSA',int2str(namesP2)))
    xlabel('Indel length')
    ylabel('frequency')
...
%     ylabel('frequency')   
    ...
    figure,
    histogram(Inf_P_countMSA3,'Normalization','count')
    title(strcat('ProPIP+k-scale-3.0,-Inferred-MSA',int2str(namesP3)))
    xlabel('Indel length')
    ylabel('frequency') 
