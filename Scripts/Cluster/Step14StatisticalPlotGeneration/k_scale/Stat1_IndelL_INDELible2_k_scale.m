...
% Date: 22.04.2020
%% This process is with INDELible data with cut-off, m=20, k_scaled
%% Add paths
baseType0= 'k_0_25'; % % %
baseType1= 'k_0_5';
baseType2= 'k_2_0';
...
addpath(strcat('/Users/pouloeld/Documents/Statistics2/INDELible/ProPIP/k_scale','/',baseType0))
addpath(strcat('/Users/pouloeld/Documents/Statistics2/INDELible/ProPIP/k_scale','/',baseType1))
addpath(strcat('/Users/pouloeld/Documents/Statistics2/INDELible/ProPIP/k_scale','/',baseType2))
addpath(strcat('/Users/pouloeld/Documents/Statistics2/INDELible/ProPIP/k_scale','/',baseType3))
...
Inf_I_Path0= strcat('/Users/pouloeld/Documents/Statistics2/INDELible/ProPIP/k_scale','/',baseType0); 
Inf_I_files0= dir(fullfile(Inf_I_Path0,'*.fasta'));
Inf_I_Names0= {Inf_I_files0.name};
tk_i0= regexp(Inf_I_Names0,'((?<=ProPIPk0inferredMSA_I_)\d*)','match');
...
Inf_I_Path1= strcat('/Users/pouloeld/Documents/Statistics2/INDELible/ProPIP/k_scale','/',baseType1); 
Inf_I_files1= dir(fullfile(Inf_I_Path1,'*.fasta'));
Inf_I_Names1= {Inf_I_files1.name};
tk_i1= regexp(Inf_I_Names1,'((?<=ProPIPk1inferredMSA_I_)\d*)','match');
...
Inf_I_Path2= strcat('/Users/pouloeld/Documents/Statistics2/INDELible/ProPIP/k_scale','/',baseType2); 
Inf_I_files2= dir(fullfile(Inf_I_Path2,'*.fasta'));
Inf_I_Names2= {Inf_I_files2.name};
tk_i2= regexp(Inf_I_Names2,'((?<=ProPIPk2inferredMSA_I_)\d*)','match');
...
Inf_I_Path3= strcat('/Users/pouloeld/Documents/Statistics2/INDELible/ProPIP/k_scale','/',baseType3); 
Inf_I_files3= dir(fullfile(Inf_I_Path3,'*.fasta'));
Inf_I_Names3= {Inf_I_files3.name};
tk_i3= regexp(Inf_I_Names3,'((?<=ProPIPk3inferredMSA_I_)\d*)','match');
        ...
        for seqL=1:length(Inf_I_MSA0(nTaxa).Sequence)
            ...
            elseif Inf_I_MSA0(nTaxa).Sequence(seqL) ~= '-'
                if count ~= 0
                    ...
                    if count>29
                        maxMSA0=[maxMSA0,namesI0];
                        disp(Inf_I_Names0(namesI0))
                        disp(namesI0)
                    end
                    count=0;
                end
...
%     ylabel('frequency')
    ...
    title(strcat('ProPIP+k-scale-0.25,Inferred-MSA',int2str(namesI0)))
    xlabel('Indel length')
    ylabel('frequency')
...
%     ylabel('frequency')
    ...
    title(strcat('ProPIP+k-scale-0.5,-Inferred-MSA',int2str(namesI1)))
    xlabel('Indel length')
    ylabel('frequency')
        ...
        for seqL=1:length(Inf_I_MSA2(nTaxa).Sequence)
            ...
            elseif Inf_I_MSA2(nTaxa).Sequence(seqL) ~= '-'
                if count ~= 0
                    ...
                    if count>42
                        maxMSA2=[maxMSA2,namesI2];
                        disp(Inf_I_Names2(namesI2))
                        disp(namesI2)
                    end
                    count=0;
                end
...
%     ylabel('frequency')
    ...
    title(strcat('ProPIP+k-scale-2.0,-Inferred-MSA',int2str(namesI2)))
    xlabel('Indel length')
    ylabel('frequency')
        ...
        for seqL=1:length(Inf_I_MSA3(nTaxa).Sequence)
            ...
            elseif Inf_I_MSA3(nTaxa).Sequence(seqL) ~= '-'
                if count ~= 0
                    ...
                    if count>36
                        maxMSA3=[maxMSA3,namesI3];
                        disp(Inf_I_Names3(namesI3))
                        disp(namesI3)
                    end
                    count=0;
                end
...
%     ylabel('frequency')   
    ...
    title(strcat('ProPIP+k-scale-3.0,-Inferred-MSA',int2str(namesI3)))
    xlabel('Indel length')
    ylabel('frequency') 
