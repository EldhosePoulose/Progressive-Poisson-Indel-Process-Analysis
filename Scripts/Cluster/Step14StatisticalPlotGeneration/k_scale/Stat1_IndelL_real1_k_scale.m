...
% Date: 22.04.2020
%% This process is with real data with cut-off, m=20
%% Add paths
baseType0= 'k_0_25'; % % %
baseType1= 'k_0_5';
baseType2= 'k_2_0';
...
addpath(strcat('/Users/pouloeld/Documents/Statistics2/real/ProPIP/k_scale','/',baseType0))
addpath(strcat('/Users/pouloeld/Documents/Statistics2/real/ProPIP/k_scale','/',baseType1))
addpath(strcat('/Users/pouloeld/Documents/Statistics2/real/ProPIP/k_scale','/',baseType2))
addpath(strcat('/Users/pouloeld/Documents/Statistics2/real/ProPIP/k_scale','/',baseType3))
...
Inf_r_Path0= strcat('/Users/pouloeld/Documents/Statistics2/real/ProPIP/k_scale','/',baseType0); 
Inf_r_files0= dir(fullfile(Inf_r_Path0,'*.fasta'));
Inf_r_Names0= {Inf_r_files0.name};
tk_i0= regexp(Inf_r_Names0,'((?<=ProPIPk0inferredMSA_r_)\d*)','match');
...
Inf_r_Path1= strcat('/Users/pouloeld/Documents/Statistics2/real/ProPIP/k_scale','/',baseType1); 
Inf_r_files1= dir(fullfile(Inf_r_Path1,'*.fasta'));
Inf_r_Names1= {Inf_r_files1.name};
tk_i1= regexp(Inf_r_Names1,'((?<=ProPIPk1inferredMSA_r_)\d*)','match');
...
Inf_r_Path2= strcat('/Users/pouloeld/Documents/Statistics2/real/ProPIP/k_scale','/',baseType2); 
Inf_r_files2= dir(fullfile(Inf_r_Path2,'*.fasta'));
Inf_r_Names2= {Inf_r_files2.name};
tk_i2= regexp(Inf_r_Names2,'((?<=ProPIPk2inferredMSA_r_)\d*)','match');
...
Inf_r_Path3= strcat('/Users/pouloeld/Documents/Statistics2/real/ProPIP/k_scale','/',baseType3); 
Inf_r_files3= dir(fullfile(Inf_r_Path3,'*.fasta'));
Inf_r_Names3= {Inf_r_files3.name};
tk_i3= regexp(Inf_r_Names3,'((?<=ProPIPk3inferredMSA_r_)\d*)','match');
...
%     ylabel('frequency')
    ...
    figure,
    histogram(Inf_r_countMSA0,'Normalization','count')
    title(strcat('ProPIP+k-scale-0.25,Inferred-MSA',int2str(namesr0)))
    xlabel('Indel length')
    ylabel('frequency')
...
%     ylabel('frequency')
    ...
    figure,
    histogram(Inf_r_countMSA1,'Normalization','count')
    title(strcat('ProPIP+k-scale-0.5,-Inferred-MSA',int2str(namesr1)))
    xlabel('Indel length')
    ylabel('frequency')
...
%     ylabel('frequency')
    ...
    figure,
    histogram(Inf_r_countMSA2,'Normalization','count')
    title(strcat('ProPIP+k-scale-2.0,-Inferred-MSA',int2str(namesr2)))
    xlabel('Indel length')
    ylabel('frequency')
...
%     ylabel('frequency')   
    ...
    figure,
    histogram(Inf_r_countMSA3,'Normalization','count')
    title(strcat('ProPIP+k-scale-3.0,-Inferred-MSA',int2str(namesr3)))
    xlabel('Indel length')
    ylabel('frequency')  
