...
shfileName='run_ProPIP_gamma4_';

%addpath('/Users/pouloeld/Documents/Alignment_Generation/inputs/INDELible_ins/ProPIP_k_params_I/k_0_25')
params_file_path_I= 'Alignment_Generation/inputs/INDELible_ins/ProPIP_gamma_params_I/n_4_a_0_1';
params_file_path_P= 'Alignment_Generation/inputs/ProPIP_ins/ProPIP_gamma_params_P/n_4_a_0_1';
params_file_path_r= 'Alignment_Generation/inputs/realData_ins/ProPIP_gamma_params_r/n_4_a_0_1';
...
for i=1:nIter
    ...
    line14= 'do';
    line15= strcat('   srun',' ./miniJATI2',' params=',clusterPath,params_file_path_I,'/','ins_gammaparams_I_$nFiles.txt');
    line151= strcat('   srun',' ./miniJATI2',' params=',clusterPath,params_file_path_P,'/','ins_gammaparams_P_$nFiles.txt');
    line161='done';
    
    line132= strcat('for',' nFiles',' in',' {1..4}');
    line142= 'do';
    line152= strcat('   srun',' ./miniJATI2',' params=',clusterPath,params_file_path_r,'/','ins_gammaparams_r_$nFiles.txt');
    line162='done';
