...
clear all
%% DATA ANALYSIS
addpath("/Users/pouloeld/Desktop/Step14StatisticalPlotGeneration/StatisticsIndeLData/allData")
mat= dir('*.mat');
for q = 1:length(mat)
...
% 
% figure,
% bar(edges(1:end-1),[I1;I2;I3;I4;I5;I6;I7;I8;I9]')
% title('INDELible data with cut off=20')
% xlabel('Indel Length')
% ylabel('Frequency')
% legend('True-INDELible-with-cut-off=20','Mafft Inferred','Prank Inferred','ProPIP Inferred', 'ProPIP+Gamma(n=4,alpha=0.1)','ProPIP+Gamma(n=4,alpha=0.5)','ProPIP+Gamma(n=4,alpha=1.0)','ProPIP+Gamma(n=4,alpha=2.0)','ProPIP+Gamma(n=4,alpha=3.0)' )
...
% 
% figure,
% bar(edges(1:end-1),[P1;P2;P3;P4;P5;P6;P7;P8;P9]')
% title('PIPJava data')
% xlabel('Indel Length')
% ylabel('Frequency')
% legend('True-PIPJava','Mafft Inferred','Prank Inferred','ProPIP Inferred', 'ProPIP+Gamma(n=4,alpha=0.1)','ProPIP+Gamma(n=4,alpha=0.5)','ProPIP+Gamma(n=4,alpha=1.0)','ProPIP+Gamma(n=4,alpha=2.0)','ProPIP+Gamma(n=4,alpha=3.0)' )
...
% 
% figure,
% bar(edges(1:end-1),[r1;r2;r3;r4;r5;r6;r7;r8;r9]')
% title('real data')
% xlabel('Indel Length')
% ylabel('Frequency')
% legend('real data','Mafft Inferred','Prank Inferred','ProPIP Inferred', 'ProPIP+Gamma(n=4,alpha=0.1)','ProPIP+Gamma(n=4,alpha=0.5)','ProPIP+Gamma(n=4,alpha=1.0)','ProPIP+Gamma(n=4,alpha=2.0)','ProPIP+Gamma(n=4,alpha=3.0)' )
