...
addpath(strcat('/Users/pouloeld/Documents/Statistics2/PIPJava/ProPIP/Gamma','/',baseType4))
...
Inf_P_Path3= strcat('/Users/pouloeld/Documents/Statistics2/PIPJava/ProPIP/Gamma','/',baseType4); 
Inf_P_files3= dir(fullfile(Inf_P_Path3,'*.fasta'));
Inf_P_Names3= {Inf_P_files3.name};
tk_i3= regexp(Inf_P_Names3,'((?<=ProPIPgamma4inferredMSA_P_)\d*)','match');
[~,ti3]= sortrows(str2double(cat(1,tk_i3{:})));
Inf_P_Names3= Inf_P_Names3(ti3); %tii for INDELible tpp for PIPJava trr for real
nIter_P3= length(Inf_P_Names3);
