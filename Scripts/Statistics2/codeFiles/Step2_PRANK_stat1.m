...
% xlabel('INDEL length per sequence')
% ylabel('probability')
% title("INDEL length per sequence, PRANK.Inf.MSA -INDELible data")
% 
...
% xlabel('INDEL length per sequence')
% ylabel('probability')
% title("INDEL length per sequence, PRANK.Inf.MSA -PIP data")
...
% xlabel('INDEL length per sequence')
% ylabel('probability')
% title("INDEL length per sequence, PRANK.Inf.MSA -real data")
