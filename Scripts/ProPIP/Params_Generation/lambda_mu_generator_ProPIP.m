...
%Include Inputs 
addpath('/Users/pouloeld/Documents/ProPIP/Params_Generation/inputs/ProPIP_ins/gappedMSA_ProPIP')
addpath('/Users/pouloeld/Documents/ProPIP/Params_Generation/inputs/ProPIP_ins/newicktree_ProPIP')
%Include matfiles needed for generating ⋋ & μ
addpath('/Users/pouloeld/Documents/ProPIP/Params_Generation/outputs/ProPIP_outs/mat_functions')
...
%1. MSAs
msaPath= '/Users/pouloeld/Documents/ProPIP/Params_Generation/inputs/ProPIP_ins/gappedMSA_ProPIP';
...
%2.1 Trees
treePath= '/Users/pouloeld/Documents/ProPIP/Params_Generation/inputs/ProPIP_ins/newicktree_ProPIP';
...
column_counter_path= '/Users/pouloeld/Documents/ProPIP/Params_Generation/outputs/ProPIP_outs/column_counter';
exp_seq_len_path= '/Users/pouloeld/Documents/ProPIP/Params_Generation/outputs/ProPIP_outs/exp_seq_len';
lambda_mu_path= '/Users/pouloeld/Documents/ProPIP/Params_Generation/outputs/ProPIP_outs/lambda_mu';
mat_functions_path= '/Users/pouloeld/Documents/ProPIP/Params_Generation/outputs/ProPIP_outs/mat_functions';

%% Base Names of the Output files
column_counter_file= 'column_counter_P_';
exp_seq_len_file= 'exp_seq_P_';
lambda_mu_file= 'lambda_mu_P_';
mat_functions_file= 'mat_functions_P_'; 
...
for k=1:nIter
    ...
    for m= 1:length(D)
        if strcmp(D(m).name,'Branch 1')
            D(m).name= 'Branch1';
        elseif strcmp(D(m).name,'Branch 2')
            D(m).name= 'Branch2';           
        elseif strcmp(D(m).name,'Branch 3')
            D(m).name= 'Branch3';
        elseif strcmp(D(m).name,'Branch 4')
            D(m).name= 'Branch4';
        elseif strcmp(D(m).name,'Branch 5')
            D(m).name= 'Branch5';
        elseif strcmp(D(m).name,'Branch 6')
            D(m).name= 'Branch6';
        end            
     end
