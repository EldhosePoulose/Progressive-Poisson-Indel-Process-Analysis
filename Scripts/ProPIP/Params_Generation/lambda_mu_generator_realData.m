...
addpath('/Users/pouloeld/Documents/ProPIP/Params_Generation/inputs/realData_ins/newicktree_realData')
%Include matfiles needed for generating ⋋ & μ
addpath('/Users/pouloeld/Documents/ProPIP/Params_Generation/outputs/realData_outs/mat_functions')
...
column_counter_path= '/Users/pouloeld/Documents/ProPIP/Params_Generation/outputs/realData_outs/column_counter';
exp_seq_len_path= '/Users/pouloeld/Documents/ProPIP/Params_Generation/outputs/realData_outs/exp_seq_len';
lambda_mu_path= '/Users/pouloeld/Documents/ProPIP/Params_Generation/outputs/realData_outs/lambda_mu';
mat_functions_path= '/Users/pouloeld/Documents/ProPIP/Params_Generation/outputs/realData_outs/mat_functions';

%% Base Names of the Output files
column_counter_file= 'column_counter_r_';
exp_seq_len_file= 'exp_seq_r_';
lambda_mu_file= 'lambda_mu_r_';
mat_functions_file= 'mat_functions_r_'; 
...
for k=1:nIter
    ...
    % for non labelled internal node trees This needs to be verified and
    % depend on number of taxa that we have on tree. Need to find out what
    % can do with this. This is hard when we have more taxa. Error prone
    % area as per my view is when we right matfiles in this section II. The
    % system generated internal node labels contain spaces in between which
    % create error. while running section III. 
    D(14).name= 'internal_1';
    D(15).name= 'internal_2';
    D(16).name= 'internal_3';
    D(17).name= 'internal_4';
    D(18).name= 'internal_5';
    D(19).name= 'internal_6';
    D(20).name= 'internal_7';
    D(21).name= 'internal_8';
    D(22).name= 'internal_9';
    D(23).name= 'internal_10';
    D(24).name= 'internal_11';
...
for u=1:nIter
    ...
    fid_lambda_mu= fopen(strcat(lambda_mu_path,'/',lambda_mu_file,num2str(u),'.txt'),'w');
