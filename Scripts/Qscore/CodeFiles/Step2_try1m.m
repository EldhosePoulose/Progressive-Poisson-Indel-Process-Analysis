...
title("Averge INDEL length per Inf.MSA -INDELible data, Inf.PRANK")
...
title("Averge INDEL length per Inf.MSA -PIP data, Inf.PRANK")
...
title("Averge INDEL length per Inf.MSA -real data, Inf.PRANK")