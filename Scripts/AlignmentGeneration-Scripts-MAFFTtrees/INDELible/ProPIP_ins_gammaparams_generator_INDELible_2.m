...
%% params_out location
params_file_path= '/Users/pouloeld/Documents/Alignment_Generation/inputs/INDELible_ins/ProPIP_gamma_params_I/n_4_a_0_1';
%% Base Names of the Output files
params_file= 'ins_gammaparams_I_';


%% for params_file
ungappedMSA_path= '/cfs/earth/scratch/pouloeld/Alignment_Generation/inputs/INDELible_ins/ungappedMSA_INDELible/m_20';
input_tree_path= '/cfs/earth/scratch/pouloeld/Alignment_Generation/inputs/INDELible_ins/newicktree_INDELible/m_20';

aligned_msa_path= '/cfs/earth/scratch/pouloeld/Alignment_Generation/outputs/Alignment_ProPIP/INDELible_Aligned/aligned_MSA/n_4_a_0_1';
aligned_tree_path= '/cfs/earth/scratch/pouloeld/Alignment_Generation/outputs/Alignment_ProPIP/INDELible_Aligned/aligned_Tree/n_4_a_0_1';
aligned_estimates_path= '/cfs/earth/scratch/pouloeld/Alignment_Generation/outputs/Alignment_ProPIP/INDELible_Aligned/aligned_estimates/n_4_a_0_1';
aligned_lk_path= '/cfs/earth/scratch/pouloeld/Alignment_Generation/outputs/Alignment_ProPIP/INDELible_Aligned/aligned_lk/n_4_a_0_1';
...
aligned_estimates_name= 'aligngamma4log_I_';
aligned_lk_name= 'aligngamma4lk_I_';
