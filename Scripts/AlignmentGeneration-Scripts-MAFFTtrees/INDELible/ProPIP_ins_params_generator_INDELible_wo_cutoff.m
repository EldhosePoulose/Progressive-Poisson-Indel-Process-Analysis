...
addpath('/Users/pouloeld/Documents/ProPIP/Params_Generation/outputs/INDELible_outs/lambda_mu/wo_cutoff');

addpath('/Users/pouloeld/Documents/Alignment_Generation/inputs/INDELible_ins/ungappedMSA_INDELible/wo_cutoff')
addpath('/Users/pouloeld/Documents/Alignment_Generation/inputs/INDELible_ins/newicktree_INDELible/wo_cutoff')
...
%% for params_file
ungappedMSA_path= strcat(clusterPath,'Alignment_Generation/inputs/INDELible_ins/ungappedMSA_INDELible/wo_cutoff');
input_tree_path= strcat(clusterPath,'Alignment_Generation/inputs/INDELible_ins/newicktree_INDELible/wo_cutoff');

aligned_msa_path= strcat(clusterPath,'Alignment_Generation/outputs/Alignment_ProPIP/INDELible_Aligned/aligned_MSA/wo_cutoff');
aligned_tree_path= strcat(clusterPath,'Alignment_Generation/outputs/Alignment_ProPIP/INDELible_Aligned/aligned_Tree/wo_cutoff');
aligned_estimates_path= strcat(clusterPath,'Alignment_Generation/outputs/Alignment_ProPIP/INDELible_Aligned/aligned_estimates/wo_cutoff');
aligned_lk_path= strcat(clusterPath,'Alignment_Generation/outputs/Alignment_ProPIP/INDELible_Aligned/aligned_lk/wo_cutoff');

msa_ext= '.fasta';
tree_ext= '.newick';
other_ext= '.txt';

aligned_msa_name= 'ProPIPinferredMSA_I_';
aligned_tree_name= 'alignTREE_I_';
aligned_estimates_name= 'alignlog_I_';
aligned_lk_name= 'alignlk_I_';

%% INPUTS file details
%1. MSAs
msaPath= '/Users/pouloeld/Documents/Alignment_Generation/inputs/INDELible_ins/ungappedMSA_INDELible/wo_cutoff';
...
%2.1 Trees
treePath= '/Users/pouloeld/Documents/Alignment_Generation/inputs/INDELible_ins/newicktree_INDELible/wo_cutoff';
...
%% lambda mu files
lambdamuPath= '/Users/pouloeld/Documents/ProPIP/Params_Generation/outputs/INDELible_outs/lambda_mu/wo_cutoff';
...
for ID=1:nIter
    %exp_seq_len
    strMSA=char(allmsaNames(ID));
    startIndex(ID)= sscanf(strMSA,'out_%d'); %% number ID present in the file
end
...
for i=1:nIter
    ...
    disp(strcat('retrieving values from lm file...',lm_file_name))
    
    fid_params= fopen(strcat(params_file_path,'/',params_file,num2str(startIndex(i)),other_ext),'w');
    
    disp(strcat('Printing params files...',params_file,num2str(startIndex(i))))
    ...
    line15= strcat('output.msa.file=',aligned_msa_path,'/',aligned_msa_name,num2str(startIndex(i)),msa_ext);
    
    line16= strcat('output.tree.file=',aligned_tree_path,'/',aligned_tree_name,num2str(startIndex(i)),tree_ext);   
    
    line17= strcat('output.estimates.file=',aligned_estimates_path,'/',aligned_estimates_name,num2str(startIndex(i)),other_ext);
    
    line18= strcat('output.lk.file=',aligned_lk_path,'/',aligned_lk_name,num2str(startIndex(i)),other_ext);  
