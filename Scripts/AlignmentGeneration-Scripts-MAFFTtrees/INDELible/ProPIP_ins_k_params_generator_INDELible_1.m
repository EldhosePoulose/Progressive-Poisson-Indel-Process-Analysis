...
%% params_out location
params_file_path= '/Users/pouloeld/Documents/Alignment_Generation/inputs/INDELible_ins/ProPIP_k_params_I/k_3_0';
...
aligned_msa_path= strcat(clusterPath,'Alignment_Generation/outputs/Alignment_ProPIP/INDELible_Aligned/aligned_MSA/k_3_0');
aligned_tree_path= strcat(clusterPath,'Alignment_Generation/outputs/Alignment_ProPIP/INDELible_Aligned/aligned_Tree/k_3_0');
aligned_estimates_path= strcat(clusterPath,'Alignment_Generation/outputs/Alignment_ProPIP/INDELible_Aligned/aligned_estimates/k_3_0');
aligned_lk_path= strcat(clusterPath,'Alignment_Generation/outputs/Alignment_ProPIP/INDELible_Aligned/aligned_lk/k_3_0');
msa_ext= '.fasta';
tree_ext= '.newick';
other_ext= '.txt';

aligned_msa_name= 'ProPIPk3inferredMSA_I_';
aligned_tree_name= 'alignk3TREE_I_';
aligned_estimates_name= 'alignk3log_I_';
aligned_lk_name= 'alignk3lk_I_';
