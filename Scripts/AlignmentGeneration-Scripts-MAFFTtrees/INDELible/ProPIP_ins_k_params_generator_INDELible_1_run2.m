...
%% params_out location
params_file_path= '/Users/pouloeld/Documents/Alignment_Generation/inputs/INDELible_ins/ProPIP_k_params_I/k_0_10';
...
aligned_msa_path= strcat(clusterPath,'Alignment_Generation/outputs/Alignment_ProPIP/INDELible_Aligned/aligned_MSA/k_0_10');
aligned_tree_path= strcat(clusterPath,'Alignment_Generation/outputs/Alignment_ProPIP/INDELible_Aligned/aligned_Tree/k_0_10');
aligned_estimates_path= strcat(clusterPath,'Alignment_Generation/outputs/Alignment_ProPIP/INDELible_Aligned/aligned_estimates/k_0_10');
aligned_lk_path= strcat(clusterPath,'Alignment_Generation/outputs/Alignment_ProPIP/INDELible_Aligned/aligned_lk/k_0_10');
msa_ext= '.fasta';
tree_ext= '.newick';
other_ext= '.txt';

aligned_msa_name= 'ProPIPk5inferredMSA_I_';
aligned_tree_name= 'alignk5TREE_I_';
aligned_estimates_name= 'alignk5log_I_';
aligned_lk_name= 'alignk5lk_I_';
