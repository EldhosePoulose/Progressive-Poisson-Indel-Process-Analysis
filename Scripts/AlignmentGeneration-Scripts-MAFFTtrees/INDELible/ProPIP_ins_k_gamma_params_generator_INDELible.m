...
addpath('/Users/pouloeld/Documents/ProPIP/Params_Generation/outputs/INDELible_outs/lambda_mu/m_20');

addpath('/Users/pouloeld/Documents/Alignment_Generation/inputs/INDELible_ins/ungappedMSA_INDELible/m_20')
addpath('/Users/pouloeld/Documents/Alignment_Generation/inputs/INDELible_ins/newicktree_INDELible/m_20')

%% params_out location
params_file_path= '/Users/pouloeld/Documents/Alignment_Generation/inputs/INDELible_ins/ProPIP_k_Gamma_params_I/k_0_10_n_4_a_0_10';
...
%%paramter gamma n= alpha=

%% Base Names of the Output files
params_file= 'ins_kg11_params_I_';


%% for params_file
ungappedMSA_path= strcat(clusterPath,'Alignment_Generation/inputs/INDELible_ins/ungappedMSA_INDELible/m_20');
input_tree_path= strcat(clusterPath,'Alignment_Generation/inputs/INDELible_ins/newicktree_INDELible/m_20');

aligned_msa_path= strcat(clusterPath,'Alignment_Generation/outputs/Alignment_ProPIP/INDELible_Aligned/aligned_MSA/k_Gamma/k_0_10_n_4_a_0_10');
aligned_tree_path= strcat(clusterPath,'Alignment_Generation/outputs/Alignment_ProPIP/INDELible_Aligned/aligned_Tree/k_Gamma/k_0_10_n_4_a_0_10');
aligned_estimates_path= strcat(clusterPath,'Alignment_Generation/outputs/Alignment_ProPIP/INDELible_Aligned/aligned_estimates/k_Gamma/k_0_10_n_4_a_0_10');
aligned_lk_path= strcat(clusterPath,'Alignment_Generation/outputs/Alignment_ProPIP/INDELible_Aligned/aligned_lk/k_Gamma/k_0_10_n_4_a_0_10');
msa_ext= '.fasta';
tree_ext= '.newick';
other_ext= '.txt';

aligned_msa_name= 'ProPIPkg11inferredMSA_I_';
aligned_tree_name= 'alignkg11TREE_I_';
aligned_estimates_name= 'alignkg11log_I_';
aligned_lk_name= 'alignkg11lk_I_';

%% INPUTS file details
%1. MSAs
msaPath= '/Users/pouloeld/Documents/Alignment_Generation/inputs/INDELible_ins/ungappedMSA_INDELible/m_20';
...
%2.1 Trees
treePath= '/Users/pouloeld/Documents/Alignment_Generation/inputs/INDELible_ins/newicktree_INDELible/m_20';
...
%% lambda mu files
lambdamuPath= '/Users/pouloeld/Documents/ProPIP/Params_Generation/outputs/INDELible_outs/lambda_mu/m_20';
