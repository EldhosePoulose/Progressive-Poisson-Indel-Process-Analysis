...
%% params_out location
params_file_path= '/Users/pouloeld/Documents/Alignment_Generation/inputs/realData_ins/ProPIP_k_Gamma_params_r/k_0_10_n_4_a_0_10';
%% Base Names of the Output files
params_file= 'ins_kg11_params_r_';
...
aligned_msa_path= strcat(clusterPath,'Alignment_Generation/outputs/Alignment_ProPIP/realData_Aligned/aligned_MSA/k_Gamma/k_0_10_n_4_a_0_10');
aligned_tree_path= strcat(clusterPath,'Alignment_Generation/outputs/Alignment_ProPIP/realData_Aligned/aligned_Tree/k_Gamma/k_0_10_n_4_a_0_10');
aligned_estimates_path= strcat(clusterPath,'Alignment_Generation/outputs/Alignment_ProPIP/realData_Aligned/aligned_estimates/k_Gamma/k_0_10_n_4_a_0_10');
aligned_lk_path= strcat(clusterPath,'Alignment_Generation/outputs/Alignment_ProPIP/realData_Aligned/aligned_lk/k_Gamma/k_0_10_n_4_a_0_10');

msa_ext= '.fasta';
tree_ext= '.newick';
other_ext= '.txt';

aligned_msa_name= 'ProPIPkg11inferredMSA_r_';
aligned_tree_name= 'alignkg11TREE_r_';
aligned_estimates_name= 'alignkg11log_r_';
aligned_lk_name= 'alignkg11lk_r_';
