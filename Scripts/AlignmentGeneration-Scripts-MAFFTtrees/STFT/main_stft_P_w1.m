...
addpath(strcat(pcPath,'Alignment_Generation/inputs/ProPIP_ins/ungappedMSA_ProPIP'))
addpath(strcat(pcPath,'Alignment_Generation/inputs/ProPIP_ins/newicktree_ProPIP'))
%addpath(strcat(pcPath,'ProPIP/Params_Generation/outputs/ProPIP_outs/lambda_mu'));
...
%% OUT file path
output_MSA_path= strcat(pcPath,'Alignment_Generation/STFT/outputs/PIP/welch/w_128');
output_file_name= 'ProPIP_stft_w_128_MSA_P_';
Seq_ext= ".fasta";

%% INPUTS file details

%1 ungapped MSAs
msaPath= strcat(pcPath,'Alignment_Generation/inputs/ProPIP_ins/ungappedMSA_ProPIP');
...
%2 Trees
treePath= strcat(pcPath,'Alignment_Generation/inputs/ProPIP_ins/newicktree_ProPIP');
...
%3 lambda mu files
lambdamuPath= strcat(pcPath,'ProPIP/Params_Generation/outputs/ProPIP_outs/lambda_mu');
