...
%% params_out location
params_file_path= '/Users/pouloeld/Documents/Alignment_Generation/inputs/ProPIP_ins/ProPIP_gamma_params_P/n_4_a_0_1';
%% Base Names of the Output files
params_file= 'ins_gammaparams_P_';


%% for params_file
ungappedMSA_path= '/cfs/earth/scratch/pouloeld/Alignment_Generation/inputs/ProPIP_ins/ungappedMSA_ProPIP';
input_tree_path= '/cfs/earth/scratch/pouloeld/Alignment_Generation/inputs/ProPIP_ins/newicktree_ProPIP';

aligned_msa_path= '/cfs/earth/scratch/pouloeld/Alignment_Generation/outputs/Alignment_ProPIP/ProPIP_Aligned/aligned_MSA/n_4_a_0_1';
aligned_tree_path= '/cfs/earth/scratch/pouloeld/Alignment_Generation/outputs/Alignment_ProPIP/ProPIP_Aligned/aligned_Tree/n_4_a_0_1';
aligned_estimates_path= '/cfs/earth/scratch/pouloeld/Alignment_Generation/outputs/Alignment_ProPIP/ProPIP_Aligned/aligned_estimates/n_4_a_0_1';
aligned_lk_path= '/cfs/earth/scratch/pouloeld/Alignment_Generation/outputs/Alignment_ProPIP/ProPIP_Aligned/aligned_lk/n_4_a_0_1';

msa_ext= '.fasta';
tree_ext= '.newick';
other_ext= '.txt';

aligned_msa_name= 'ProPIPgamma4inferredMSA_P_';
aligned_tree_name= 'aligngamma4TREE_P_';
aligned_estimates_name= 'aligngamma4log_P_';
aligned_lk_name= 'aligngamma4lk_P_';
