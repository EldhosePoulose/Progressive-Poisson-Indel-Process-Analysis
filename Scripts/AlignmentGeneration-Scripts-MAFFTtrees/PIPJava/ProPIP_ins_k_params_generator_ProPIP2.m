...
%% params_out location
params_file_path= '/Users/pouloeld/Documents/Alignment_Generation/inputs/ProPIP_ins/ProPIP_k_params_P/k_0_05';
%% Base Names of the Output files
params_file= 'ins_k4_params_P_';
...
aligned_msa_path= strcat(clusterPath,'Alignment_Generation/outputs/Alignment_ProPIP/ProPIP_Aligned/aligned_MSA/k_0_05');
aligned_tree_path= strcat(clusterPath,'Alignment_Generation/outputs/Alignment_ProPIP/ProPIP_Aligned/aligned_Tree/k_0_05');
aligned_estimates_path= strcat(clusterPath,'Alignment_Generation/outputs/Alignment_ProPIP/ProPIP_Aligned/aligned_estimates/k_0_05');
aligned_lk_path= strcat(clusterPath,'Alignment_Generation/outputs/Alignment_ProPIP/ProPIP_Aligned/aligned_lk/k_0_05');
msa_ext= '.fasta';
tree_ext= '.newick';
other_ext= '.txt';

aligned_msa_name= 'ProPIPk4inferredMSA_P_';
aligned_tree_name= 'alignk4TREE_P_';
aligned_estimates_name= 'alignk4log_P_';
aligned_lk_name= 'alignk4lk_P_';
