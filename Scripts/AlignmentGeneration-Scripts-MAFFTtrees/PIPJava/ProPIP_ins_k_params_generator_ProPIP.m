...
%% params_out location
params_file_path= '/Users/pouloeld/Documents/Alignment_Generation/inputs/ProPIP_ins/ProPIP_k_params_P/k_3_0';
%% Base Names of the Output files
params_file= 'ins_k3_params_P_';
...
aligned_msa_path= strcat(clusterPath,'Alignment_Generation/outputs/Alignment_ProPIP/ProPIP_Aligned/aligned_MSA/k_3_0');
aligned_tree_path= strcat(clusterPath,'Alignment_Generation/outputs/Alignment_ProPIP/ProPIP_Aligned/aligned_Tree/k_3_0');
aligned_estimates_path= strcat(clusterPath,'Alignment_Generation/outputs/Alignment_ProPIP/ProPIP_Aligned/aligned_estimates/k_3_0');
aligned_lk_path= strcat(clusterPath,'Alignment_Generation/outputs/Alignment_ProPIP/ProPIP_Aligned/aligned_lk/k_3_0');
msa_ext= '.fasta';
tree_ext= '.newick';
other_ext= '.txt';
